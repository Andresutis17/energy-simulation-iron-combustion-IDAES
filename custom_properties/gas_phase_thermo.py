"""
Custom gas phase property package for iron-energy CLC modeling.
Components O2, N2, CO2, H2O, H2

Extends IDAES oxygen_iron_OC_oxidation gas phase by adding H2.
...
@declare_process_block_class("CustomGasPhaseParameterBlock")
class PhysicalParameterData(PhysicalParameterBlock):
    """
    Property Parameter Block Class
    Contains parameters and indexing sets associated with gas phase properties
    for iron-energy storage CLC.
    Components: O2, N2, CO2, H2O, H2
    """
    ...
    def build(self):
        ...
        self._state_block_class = CustomGasPhaseStateBlock
        ...
        #
        # H2 uses 1000-2500K range (appropriate for CLC temperatures)
        cp_param_dict = {
            ("O2", 1): 30.03235,
            ("O2", 2): 8.772972,
            ("O2", 3): -3.988133,
...
class _CustomGasPhaseStateBlock(StateBlock):
    """
...
@declare_process_block_class("CustomGasPhaseStateBlock", block_class=_CustomGasPhaseStateBlock)
class GasPhaseStateBlockData(StateBlockData):
    """
    Gas phase state block for iron-energy storage CLC
    """
    ...
    def _enth_mol_comp(self):
        ...
        def pure_comp_enthalpy(b, j):
            ...
            return b.enth_mol_comp[j] == pyunits.convert(
                # parameters 1-5 are defined in Joules
                ...
                # parameters 6 and 8 are defined in kilo Joules, and must be added
